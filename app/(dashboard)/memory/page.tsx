...
import { Check, Save, Loader2, BrainCircuit, Sparkles } from "lucide-react";
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed mb-3">
            Every company you score gets an <span className="text-cyan-400 font-medium">ICP Fit %</span> alongside its intent score — showing how well that company matches your Memory profile.
          </p>
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        <div>
          <div className="flex items-center gap-2.5 mb-1">
            ...
            <span className="text-cyan-600 dark:text-cyan-400 text-xs tracking-[0.25em] uppercase font-bold">[MEMORY]</span>
          </div>
