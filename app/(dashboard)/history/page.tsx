...
export default async function HistoryPage() {
  ...
  // This is an async Server Component that runs once per request — there's no
  // client-side re-render to produce an inconsistent result, so reading the
  // current time here isn't the purity hazard this rule targets.
