    ...
    >
      ...
      <div className="relative z-10 max-w-xl w-full px-4 sm:px-8">
        ...
        <div className="space-y-1 mb-12 overflow-hidden">
          <p className="text-[#e8ff40]/60 text-xs tracking-[0.3em]">[[</p>
          <p className="text-[#dfff00] text-sm tracking-[0.2em] ml-4">[loading]</p>
          <p className="text-[#e8ff40]/60 text-xs tracking-[0.3em] ml-8">]]]</p>
